    ...
    <>
      ...
      <div className="px-6 pt-10 pb-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">利用規約</h1>
          <div className="mt-10 max-w-2xl">
            <p>
              この利用規約（以下，「本規約」といいます。）は株式会社ArGate以下，「当社」といいます。）が
            ...
            <div className="mt-8">
              ...
              <ul className="mt-4 pl-5 list-decimal">
                <li>
            ...
            <div className="mt-8">
              ...
              <ul className="mt-2 pl-5 list-decimal">
                <li>
                  法令または公序良俗に違反する行為
                </li>
                <li>
              ...
              <ul className="mt-4 pl-5 list-decimal">
                <li>
                  ...
                  <ul className="pl-5 mt-2 list-disc">
                    ...
                    <li>
                      本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、
